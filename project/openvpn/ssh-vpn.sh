...
# install badvpn
cd
wget -O /usr/sbin/badvpn "${REPO}project/badvpn/badvpn" >/dev/null 2>&1
chmod +x /usr/sbin/badvpn > /dev/null 2>&1
wget -q -O /etc/systemd/system/badvpn1.service "${REPO}project/badvpn/badvpn1.service" >/dev/null 2>&1
wget -q -O /etc/systemd/system/badvpn2.service "${REPO}project/badvpn/badvpn2.service" >/dev/null 2>&1
wget -q -O /etc/systemd/system/badvpn3.service "${REPO}project/badvpn/badvpn3.service" >/dev/null 2>&1
...
wget -O /etc/default/dropbear "${REPO}project/example/dropbear"
